        ...
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="description"
                                  ...
                                  class="w-full px-4 py-3 border rounded-lg text-sm bg-gray-50 dark:bg-gray-900
                                         ...
                                         {{ $errors->has('description') ? 'border-red-400' : '' }}">{{ old('description', $category->description) }}</textarea>
                        @error('description')
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-red-100 dark:border-red-900/30 p-5">
                ...
                <div class="flex items-center justify-between gap-4">
                    <div>
                        <p class="text-sm text-gray-700 dark:text-gray-300 font-medium">Delete this category</p>
                        <p class="text-xs text-gray-400 mt-0.5">
                            Only possible if no transactions are linked to it.
                        </p>
                    </div>
                    <form action="{{ route('categories.destroy', $category) }}"
                        ...
                        @method('DELETE')
                        <button type="submit"
                                class="text-sm text-red-500 hover:text-red-700 font-medium transition whitespace-nowrap">
                            Delete
                        </button>
                    </form>
                </div>
